$${\color{red}Hello \space \color{lightblue}and \space \color{orange}Welcome \space \color{blue}to \space \color{lightblue}My \space \color{magenta}Github!👋}$$
...
| Web technologies Asp.net core 2019-24 continue working on Asp.net core

| Cloud colab azure power BI AWS 2022-23 Continue Power BI and colab (https://colab.research.google.com/)

| MSSQL , C# applications 2019-23
...
| SPSS for master and phd thesis statistics results 2013-2017
